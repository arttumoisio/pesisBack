...
namespace pesisBackend
{
    ...
    class SQLiteQueries
    {
        ...
        )
        {
            ...
            Tuple<string,string,string> sv = filters.sarjajako(sarjajako);
            string sarjajakoGroup = sv.Item1;
            string sarjajakoFilter = sv.Item2;
            string sarjajakoErittely = sv.Item3;
